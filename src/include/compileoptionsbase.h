...
/// Select which executable from the toolchain executables would be used for linking the target.
enum class LinkerExecutableOption : int32_t
{
    /// For C-only project this is the same as CCompiler, for C++ or mixed projects this is the same
    /// as CppCompiler.
    AutoDetect = 0,
